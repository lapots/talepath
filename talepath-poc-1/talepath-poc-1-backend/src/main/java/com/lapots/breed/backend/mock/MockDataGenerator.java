package com.lapots.breed.backend.mock;
...
import com.lapots.breed.backend.data.Availability;
import com.lapots.breed.backend.data.Category;
import com.lapots.breed.backend.data.Product;
